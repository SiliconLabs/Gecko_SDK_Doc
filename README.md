...
This documentation is also available within [Simplicity Studio](http://www.silabs.com/simplicity) by clicking the *Documentation* tab. and for datasheets, reference manuals and other documentation items, download [Simplicity Studio](http://www.silabs.com/simplicity) or head over to the [document library](http://www.silabs.com/support/pages/document-library.aspx?p=MCUs--32-bit).
